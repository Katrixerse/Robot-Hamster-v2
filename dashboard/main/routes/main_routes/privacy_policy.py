...
def privacy(request):
    if request.user.is_authenticated:
        ...
        dictio = {"username": user.discord_tag,
                  "avatar": f"https://cdn.discordapp.com/avatars/{user.id}/{user.avatar}.png", "guild": guild, "head_title": "Privacy-Policy", "head_description": "You are now viewing the privacy policy"}
    else:
        dictio = {}
    return render(request, "main/privacy/main_page.html", dictio)
