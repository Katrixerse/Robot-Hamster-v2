...
module.exports = {
  ...
  run: async (bot, prefix, message, args, con) => {
    if (message.mentions.users.size < 1) return message.channel.send("You didn't mention a user to waste.");
    try {
      ...
      const data = await loadImage('./src/assets/images/wasted.png');
