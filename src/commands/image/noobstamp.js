...
module.exports = {
  ...
  run: async (bot, prefix, message, args, con) => {
    try {
      ...
      const data = await loadImage('./src/assets/images/noobstamp.png');
      const canvas = createCanvas(501, 363);
      const ctx = canvas.getContext('2d');
      ctx.drawImage(convertImage, 0, 0, 501, 363);
      ctx.drawImage(data, 0, 0, 501, 363);
